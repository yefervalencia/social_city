...
@parche_router.get("/",tags=['users'],response_model=List[User],description="Returns all users")
def get_all_users(
...
@parche_router.get('/{id}',tags=['users'],response_model=User,description="Returns data of one specific user")
...
@parche_router.post('/',tags=['users'],response_model=dict,description="Creates a new user")
...
@parche_router.put('/{id}',tags=['users'],response_model=dict,description="Updates the data of specific user")
...
@parche_router.delete('/{id}',tags=['users'],response_model=dict,description="Removes specific user")
