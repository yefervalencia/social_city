...
@category_router.get("/",tags=['users'],response_model=List[User],description="Returns all users")
def get_all_users(
...
@category_router.get('/{id}',tags=['users'],response_model=User,description="Returns data of one specific user")
...
@category_router.post('/',tags=['users'],response_model=dict,description="Creates a new user")
...
@category_router.put('/{id}',tags=['users'],response_model=dict,description="Updates the data of specific user")
...
@category_router.delete('/{id}',tags=['users'],response_model=dict,description="Removes specific user")
